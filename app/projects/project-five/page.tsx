...
const project = {
  ...
  year: "2025",
  description: "A groundbreaking project that merges artificial intelligence with sustainable design practices.",
  images: [
    "/placeholder.svg?height=1080&width=1920&text=Project+Five+Main",
    "/placeholder.svg?height=1080&width=1920&text=Project+Five+Detail+1",
    "/placeholder.svg?height=1080&width=1920&text=Project+Five+Detail+2",
    "/placeholder.svg?height=1080&width=1920&text=Project+Five+Detail+3",
  ],
  introduction:
  ...
  team: [
    ...
    { name: "Dr. Aisha Patel", role: "AI Specialist" },
    { name: "Marcus Chen", role: "Sustainability Expert" },
    { name: "Olivia Sanchez", role: "Systems Integration Engineer" },
  ],
  awards: [
    { name: "AI Innovation Award", organization: "Global Tech Forum" },
    { name: "Sustainability Impact Prize", organization: "World Economic Forum" },
  ],
}
